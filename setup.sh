...
#    /usr/local/bin/xdebugsetup 
    ...
    if [ ! -d "/var/www/html/bdp-d7/sites/default/files" ]; then
        mkdir /var/www/html/bdp-d7/sites/default/files
        chown -R apache:vagrant /var/www/html/bdp-d7/sites/default/files
    fi
    
    cp /vagrant/data/config_files/settings.php              /var/www/html/bdp-d7/sites/default/
    cp /vagrant/data/config_files/htaccess                  /var/www/html/bdp-d7/.htaccess
    chown -R apache:vagrant /var/www/html/bdp-d7
